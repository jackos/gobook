...
var inputHeader = getConfig().get("headers.input");
var outputHeader = getConfig().get("headers.output");
...
function activate(context) {
  const controller = vscode5.notebooks.createNotebookController("go-kernel", "gobook", "Go Kernel");
  ...
  context.subscriptions.push(vscode5.workspace.registerNotebookSerializer("gobook", new MarkdownProvider(), {
